package demo
{
	...
	public class Example_PerformanceTesing1 extends flash.display.Sprite
	{
		...
		public function Example_PerformanceTesing1()
		{
...
import demo.Example_PerformanceTesing1;
...
class StarlingGame extends Sprite
{
	...
	{
		removeEventListener(starling.events.Event.ADDED_TO_STAGE, addToStageHandler);
		textureCompleteHandler(null);
	}
	...
	private function textureCompleteHandler(e: Event): void
	{
		...
		armatures = [];
		Example_PerformanceTesing1.changeHandler = changeNum;
	...
	private function addObject(): void
	{
		...
		mResultText.text = "";
		var _armature: Armature = factory.buildArmature(skeletonName);
